...
public class ShowIfDrawer : PropertyDrawer
{
    ...
    {
        // Trovo la propriet� booleana che fa da condizione
        ...
        Debug.LogWarning($"ShowIf: '{showIf.ConditionField}' non � un bool!");
        return true;
    }
}
...
public class ShowIfEnumDrawer : PropertyDrawer
{
    ...
    private bool ShouldShow(SerializedProperty property, ShowIfEnumAttribute attr)
    {
        ...
        {
            Debug.LogWarning($"[ShowIfEnum] '{attr.ConditionField}' non � un Enum (tipo: {cond.propertyType}).");
            return true;
        }
...
public class AtMostOneTrueWithDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        if (other == null || other.propertyType != SerializedPropertyType.Boolean)
        {
            ...
            EditorGUI.HelpBox(warn, $"[AtMostOneTrueWith] '{attr.OtherField}' non trovato o non � bool.", MessageType.Warning);
            return;
        }
